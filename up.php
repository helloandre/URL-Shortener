...
$short_db_results = $db->query("SELECT `long`, `short` FROM `shorten`");
// build array of already used names
while ($row = $short_db_results->fetch(PDO::FETCH_ASSOC)){
...
$url_result = $db->query($url_query) or die(mysql_error());
